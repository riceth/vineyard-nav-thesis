...
- **Remaining strand work (in order):** Commits 2a–5 done (pooling, pipeline consolidation, findings, STATUS + per-month template + O012–O015, manifest cleanup + whole-bag subsample). Next: Commit 6 (non-in-row characterisation F020+, O014), report figures (O012), then multi-bag seasonal (April+) and PID.
