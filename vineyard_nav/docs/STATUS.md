...
- **Remaining strand work (in order):** Commits 2a–8 done (pooling, pipeline consolidation, findings, STATUS + per-month template, manifest cleanup + whole-bag subsample, non-in-row characterisation F020/F021, mitigation demonstration F022/F023, in-row abstention F024). Next: report figures (O012), then multi-bag seasonal (April+) and PID.
