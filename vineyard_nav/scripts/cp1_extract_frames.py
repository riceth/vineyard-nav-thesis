...
def main() -> None:
    ...
    frames = json.load(open(MAN))["frames"]
    elig = [f for f in frames if f["eligible"]]
    ...
    # (re)generate overlays: one median eligible frame per (split, corridor)
