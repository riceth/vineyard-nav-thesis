...
json.dump(report, open(PKG/"results/geometric/march/superseded/march_val_test_split/val_evaluation/config_sweep_val.json", "w"), indent=2)
...
print("wrote results/geometric/march/superseded/march_val_test_split/val_evaluation/config_sweep_val.json")
