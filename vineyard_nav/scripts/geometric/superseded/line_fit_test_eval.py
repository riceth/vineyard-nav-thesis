...
OUT_CSV = PKG/"results/geometric/march/superseded/march_val_test_split/test_evaluation/line_fit_test_per_frame.csv"
OUT_JSON = PKG/"results/geometric/march/superseded/march_val_test_split/test_evaluation/line_fit_test_report.json"
UNET_MIN = 40
MODELS = [
