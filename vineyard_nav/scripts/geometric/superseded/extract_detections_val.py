"""Extract Phase C per-detection (class, base-point) over val frames for the config sweep (D026).
Locked upstream: conf 0.25, 15% blob guard (D035). Caches seed,frame,class,uc,v to CSV for
offline reclustering. 3 seeds x 4708 frames."""
import sys, json
...
OUT = CACHE_DIR / "detections_val.csv"
