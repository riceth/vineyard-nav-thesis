...
Saves results/geometric/march/superseded/march_val_test_split/val_evaluation/paired_crossarm_val.json. Val only; nothing committed.
"""
...
json.dump(report, open(f"{PKG}/results/geometric/march/superseded/march_val_test_split/val_evaluation/paired_crossarm_val.json", "w"), indent=2)
...
print("\nwrote results/geometric/march/superseded/march_val_test_split/val_evaluation/paired_crossarm_val.json")
